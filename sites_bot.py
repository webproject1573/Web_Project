...
discord_bots = {'Бот сообщества. Бот имеет большое количество полезных функций, нужных для сообществ дискорда (Напиши индекс бота #3360)': 'https://yadi.sk/d/h6ZWwL7u2iqONg?qq=1', 'Ролеватор. Бот способен давать роли участникам, находящихся в сообществе. Каждый может получить роль, которую захочет(#3361)': 'https://yadi.sk/d/REU1OU3ImT04Vw?qq=1'}
